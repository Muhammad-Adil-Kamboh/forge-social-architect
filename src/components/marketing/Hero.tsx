  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-linkedin-50 via-white to-linkedin-100 py-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute -bottom-40 -left-40 w-80 h-80 bg-accent/20 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-float"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-linkedin-300 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-float"
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center">
          ...
          {/* Subheadline */}
          <p
            className="text-xl md:text-2xl text-gray-600 mb-8 max-w-4xl mx-auto leading-relaxed animate-slide-up"
          ...
          >
            ...
            <div className="flex -space-x-2">
              ...
              <div
                className="w-10 h-10 rounded-full bg-gray-200 border-2 border-white flex items-center justify-center text-xs font-medium text-gray-600 shadow-md animate-scale-in"
          ...
          >
            <div className="relative max-w-4xl mx-auto">
              ...
              <div
                className="absolute -top-6 -right-6 w-12 h-12 bg-linkedin-500 rounded-full flex items-center justify-center text-white font-bold animate-float"
